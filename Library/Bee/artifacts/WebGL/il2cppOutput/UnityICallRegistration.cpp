void RegisterAllStrippedInternalCalls()
{
	...
	//Start Registrations for type : UnityEngine.AI.NavMeshAgent
		...
		void Register_UnityEngine_AI_NavMeshAgent_get_nextPosition_Injected();
		Register_UnityEngine_AI_NavMeshAgent_get_nextPosition_Injected();
	...
	//Start Registrations for type : UnityEngine.ParticleSystem/LightsModule

		//System.Boolean UnityEngine.ParticleSystem/LightsModule::get_enabled_Injected(UnityEngine.ParticleSystem/LightsModule&)
		void Register_UnityEngine_ParticleSystem_LightsModule_get_enabled_Injected();
		Register_UnityEngine_ParticleSystem_LightsModule_get_enabled_Injected();
		...
		void Register_UnityEngine_ParticleSystem_LightsModule_set_enabled_Injected();
		Register_UnityEngine_ParticleSystem_LightsModule_set_enabled_Injected();

	//End Registrations for type : UnityEngine.ParticleSystem/LightsModule
	...
	//Start Registrations for type : UnityEngine.TrailRenderer
		...
		Register_UnityEngine_TrailRenderer_get_widthMultiplier();

		//System.Void UnityEngine.TrailRenderer::SetColorGradient(UnityEngine.Gradient)
		void Register_UnityEngine_TrailRenderer_SetColorGradient();
		Register_UnityEngine_TrailRenderer_SetColorGradient();
		...
		void Register_UnityEngine_TrailRenderer_set_widthMultiplier();
		Register_UnityEngine_TrailRenderer_set_widthMultiplier();

		//UnityEngine.Gradient UnityEngine.TrailRenderer::GetColorGradientCopy()
		void Register_UnityEngine_TrailRenderer_GetColorGradientCopy();
		Register_UnityEngine_TrailRenderer_GetColorGradientCopy();
